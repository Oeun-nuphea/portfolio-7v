...
export default function Hero() {
  ...
  // Words to loop in the hero
  const words = ["Full Stack Developer", "Nuxt Developer", "Backend Developer", "Microservices Enthusiast"];
    ...
    <section className="relative overflow-hidden pt-32 pb-24 px-6 lg:px-8">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="text-center lg:text-left">
          ...
          <motion.h2
            key={currentWord} // triggers re-animation on change
            initial={{ opacity: 0, y: 20, filter: "blur(8px)" }}
            animate={{ opacity: 1, y: 0, filter: "blur(0px)" }}
            exit={{ opacity: 0, y: -20 }}
            transition={{ duration: 0.8 }}
            className="text-3xl sm:text-5xl lg:text-6xl font-extrabold mb-6
